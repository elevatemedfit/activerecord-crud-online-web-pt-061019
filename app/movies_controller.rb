...
def can_be_instantiated_and_then_saved  #.new  .save class methods
  movie = Movie.new
...
def can_be_created_with_a_hash_of_attributes #
  ...
  movie = Movie.create(attributes)  #.create
end

def can_be_created_in_a_block(args = {title: "Home Alone", release_date: 1990})#@@@@@@@@@@@@@@@ ?true
...
def can_find_by_multiple_attributes #
  ...
  Movie.find_by(title: "Title", release_date: 2000, :director "Me") #can choose to find using any attribute
end
